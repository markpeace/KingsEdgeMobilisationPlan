...
> **Status:** Four-package King’s Edge investment view reconciled; Digital Student Experience Hub shown separately using the current 4.1 architecture and latest Digital and IT high-water funding baseline  
...
The **Digital Student Experience Hub** has four substantive parts: an authoritative **Student Knowledge and Information Foundation**; student-app and journey integration; an enduring multidisciplinary product capability; and the King’s Edge replatform/enhancement work that provides the first substantive native product domain.
...
The Hub continues to carry a **£3.0m working three-year strategic investment envelope**. £2.395952m is provisionally itemised on the current high-water basis, leaving **£604.048k headroom**. The headroom is not an allocation or spending target. The high-water model deliberately carries unresolved Digital and IT capacity until phasing, existing-resource deployment, Staff-Hub sharing, sourcing and scope attribution are confirmed. Confirmed reductions should be applied immediately; unsupported optimistic reductions should not.

Two evidence-led reductions are now reflected in the Student Hub case. Jon Ward confirmed that the **1.0 FTE Product Manager is allocated 50/50 between the Student and Staff Hubs**. James Costerton has now clarified that the **Solution Architect / Technical Lead should average 0.75 FTE across Year One**, front-loaded early and tapering as the architecture settles. That reduces the Year One architecture line by **£13.504k**. It is a Year One phasing decision only: later-year and BAU architecture exposure remains at high water until the enduring model is agreed.

The separate Digital Hub currently carries a **c.£893.296k p.a. worst-case recurrent Student Hub risk envelope before any enduring 4.1.1 knowledge/content operating cost**. This comprises £516.296k pay/workforce exposure and £377k non-pay/operating exposure. It is a risk ceiling rather than a settled BAU budget. The Staff Hub carries the other £47.784k p.a. Product Manager share.

For dependency and whole-system planning only, the two investments together currently give a high-water itemised profile of **£1.15356m in 2026/27, £2.480296m in 2027/28 and £2.690296m in 2028/29: £6.324152m across three years**. This combined figure should **not** be presented as the King’s Edge funding ask.
...
- **Product Manager is allocated 50/50 between Student and Staff Hubs.** The post remains a permanent 1.0 FTE institutional Product Manager costing £95,568 p.a.; the Student Hub carries £47,784 p.a. and the Staff Hub must carry the other £47,784 p.a.
- **Solution Architecture is now phased at an average 0.75 FTE in Year One**, reducing its Year One cash line from £54,016 to £40,512. The later-year and recurrent architecture requirement remains held at 1.0 FTE high water until the enduring route is evidenced.
- The previous **Dynamics Developer** line is now explicitly a **D365 / Power Platform contingency**, not a settled dedicated Hub role. The current provision remains £44,160 in Year One and £66,240 in each later year until the MVP identifies the concrete D365/Power Platform requirement and whether it can be met through the core R&C CRM team.
- Jon Ward advises that **around six months is a realistic recruitment period even if recruitment begins on day one**, with steady onboarding across that period. The gap may require contractors and/or reprioritised existing Digital and IT capacity. The remaining Year One envelope should not be reduced automatically until the bridge route and its cost are agreed.
- **Infuse QA/testing is confirmed non-pay outsourced service expenditure**, held at £6k per month: £48k in the eight-month Year One mobilisation period and £72k per full year thereafter. Its value includes test automation and non-functional testing expertise.
- **Azure/platform costs remain £50k / £75k / £100k across mobilisation, with £100k p.a. at BAU high water.** James Costerton considers this a reasonable high-water assumption; the next step is refinement from architecture, service volumes and actual consumption rather than reopening it from scratch.
- **Student-facing AI inference, retrieval and token consumption remains £50k / £75k / £100k across mobilisation, with £100k p.a. at BAU high water.** James also considers this a reasonable high-water assumption. It remains a planning envelope rather than a usage forecast and is separate from engineering-productivity tooling.
- **Devin/Cognition remains £90k p.a.** as a separate engineering-productivity allowance. One 4,000-ACU instance is retained in the Student Hub case because there is not yet evidence for a defensible pro-rata sharing model. Allocation should be revisited from actual utilisation and renewal evidence.
- James believes **DevOps may be reducible on average**, but no reduction is booked until a defensible replacement fraction or standing-service route is identified. Cloud Infrastructure and IAM similarly remain visible high-water specialist requirements pending sourcing decisions.
- Development software remains a possible Student/Staff Hub shared-cost category and should be allocated explicitly once the genuinely common tooling is identified.
- **Paid student visioning and co-design is a recurrent £15k annual product-partnership envelope across mobilisation and BAU.**
- The **£35k sandwich-year engineering placement is provisioned in Years Two and Three and is a rolling £35k p.a. BAU commitment** for one supervised placement each year. It must not substitute for experienced delivery roles.
...
<table>
  ...
  <tbody>
    <tr valign="top">
      ...
      <td valign="top"><strong>£593.360k high-water.</strong> Establishes the multidisciplinary product and technical capability and Year One operating runway; maps the institution-wide student knowledge landscape and creates an exhaustive roadmap to coverage; proves the knowledge model through detailed SASD audit, remediation, governance and first live domains in King’s Answers; funds dedicated content-design/editorial delivery; replatforms King’s Edge onto the shared product foundations; co-designs and tests the common student home; and leaves a <strong>launch-ready first Hub release plus an evidence-led backlog for progressive integration and rationalisation</strong>. The first live institutional release follows in September 2027. The cost now applies the confirmed 50/50 Product Manager allocation and James Costerton’s 0.75 FTE average Year One architecture profile. Recruitment bridge costs and other unresolved specialist lines remain held prudently until evidenced alternatives are agreed.</td>
      <td valign="top"><strong>£2.395952m current high-water itemisation within a £3.0m strategic envelope.</strong> This includes £1.461952m of Student Hub-attributed mature-team workforce and QA cash provision, £70k of sandwich-year placements, £270k Devin/Cognition tooling, £225k Azure/platform, £225k provisional student-facing AI runtime, £45k recurring paid student co-design and £99k 4.1.1 content-delivery provision. <strong>£604.048k remains as unallocated headroom</strong> pending further Digital and IT validation and evidence from delivery.</td>
      <td valign="top"><strong>c.£893.296k p.a. worst-case recurrent Student Hub risk envelope, plus TBC knowledge/content operating cost.</strong> The current ceiling comprises £276.072k Student Hub share of the permanent four-post institutional product core, £205.224k unresolved specialist workforce, £35k rolling sandwich-year placement, £72k outsourced QA, £90k agentic-development tooling, £100k Azure/platform, £100k provisional student-facing AI runtime and £15k recurring student co-design. The Staff Hub carries the other £47.784k p.a. Product Manager share. It is deliberately a high-water risk view, not a settled BAU budget.</td>
    </tr>
  </tbody>
</table>
...
|---|---:|---:|---:|---:|
| Student Hub share of mature-team workforce and QA cash provision | £355.360k | £553.296k | £553.296k | £1.461952m |
...
| **Total** | **£593.360k** | **£876.296k** | **£926.296k** | **£2.395952m** |

The £3m strategic envelope is a ceiling and planning guardrail, not an instruction to spend the remaining £604.048k. The funding case should reduce where Digital and IT can evidence credible shared, existing or differently attributed capacity.

The Product Manager split and Year One architecture average are now evidence-backed decisions. Recruitment phasing is not yet a saving: a realistic six-month recruitment period may require contractor cover or reprioritised existing Digital and IT capacity, so the rest of the Year One profile should be recut only once the bridge model is agreed. The D365 / Power Platform line should be treated as an MVP-led contingency rather than as an assumed dedicated post; DevOps is another potential reduction, but neither saving is booked before the alternative route is evidenced.
...
- **Digital Hub / recruitment:** approximately six months is the realistic recruitment assumption, with steady onboarding. The contractor/reprioritisation bridge and resulting final Year One cash profile remain to be agreed.
- **Digital Hub / architecture:** the 0.75 FTE average is now the Year One planning position. The architecture requirement after Year One and in BAU remains high water pending an enduring service model.
- **Digital Hub / D365 and specialist capacity:** D365 / Power Platform is now explicitly a contingency to test against the MVP and core R&C CRM capacity. DevOps may reduce; Cloud Infrastructure and IAM may be shared or standing services. No saving is booked until the alternative route is evidenced.
- **Digital Hub / operating consumption:** Azure/platform and student-facing AI runtime have now been sense-checked as reasonable high-water envelopes. They remain planning allowances, not forecasts, and should be converted into consumption and unit-cost forecasts as the architecture and service design mature.
- **Digital Hub / engineering productivity and cross-Hub sharing:** the full 4,000-ACU Devin/Cognition instance remains with the Student Hub for now because there is no defensible sharing basis. Actual utilisation should inform renewal. Development software and potentially other tooling remain candidates for explicit Student/Staff Hub allocation.
- **BAU:** the King’s Edge c.£1.076m p.a. and Digital Hub c.£893.296k p.a. figures are identifiable exposure/risk views rather than settled recurrent budgets. The Staff Hub has a separate £47.784k Product Manager share; several TBC items could add cost, while material high-water assumptions could reduce after MVP and sourcing decisions.
